<?php
   ...
   $sql_getinfo_hang = "select * from khuyenmai";
                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">Danh sách chương trình khuyến mại</h4>
                           </div>
                           <div class="iq-card-header-toolbar d-flex align-items-center">
                              <a href="update-khuyenmai-sanpham.php" class="mr-3 btn btn-primary">Update toàn bộ khuyến mại</a>
                              <a href="admin-add-khuyenmai.php" class="btn btn-primary">Thêm chương trình khuyến mại</a>
                           </div>
                        </div>
                        <div class="iq-card-body">
                                 ...
                                 <tbody>
                                    <?php
                                       while ($res_getinfo_hang = $stmt_getinfo_hang->fetch(PDO::FETCH_ASSOC)) {
                                          ?>
                                             <tr>
                                                <td><?php echo $res_getinfo_hang['ID_KhuyenMai']?></td>
                                                <td><?php echo $res_getinfo_hang['TenKhuyenMai']?></td>
                                                <td><?php echo $res_getinfo_hang['MoTa']?></td>
                                                <td><?php echo $res_getinfo_hang['BatDau']?></td>
                                                <td><?php echo $res_getinfo_hang['KetThuc']?></td>
                                                <td><?php echo $res_getinfo_hang['MucGiam'].'%'?></td>
                                                <td>
                                                   <div class="flex align-items-center list-user-action">
                                                      <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="admin-edit-khuyenmai.php?ID_KhuyenMai=<?php echo $res_getinfo_hang['ID_KhuyenMai']?>"><i class="ri-pencil-line"></i></a>
                                                      <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Xoá" href="admin-delete-khuyenmai.php?ID_KhuyenMai=<?php echo $res_getinfo_hang['ID_KhuyenMai']?>"><i class="ri-delete-bin-line"></i></a>
                                                   </div>
                                                </td>
                                             </tr>
                                          <?php
