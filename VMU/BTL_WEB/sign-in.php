...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->rowCount() > 0) {
        ...
        $TaiKhoan_real = $result['TaiKhoan'];
        $MatKhau_real = $result['MatKhau'];
        $type = $result['ID_LoaiTaiKhoan'];
        if(!password_verify($MatKhau, $MatKhau_real)){
            $error = 'Sai mật khẩu.';
        }else{
                          ...
                          <div class="sign-in-from bg-primary rounded">
                              ...
                              <form method="post" class="mt-4 form-text">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input name="MatKhau" type="password" required class="form-control mb-0" id="exampleInputPassword1" placeholder="Password">
