<?php
   ...
   if (!empty($_POST['submit'])) {
      ...
      $sql_add_khuyenmai = "INSERT INTO khuyenmai VALUES (NULL, :TenKhuyenMai, :MoTa, :BatDau, :KetThuc, :MucGiam)";
                                       ...
                                       if($row_notification['SoLuong'] >= 0){
                                          ...
                                          while($row_notification = $stmt_notification->fetch(PDO::FETCH_ASSOC)){
                                             if($row_notification['Status'] == 0){
                                                echo '
                                                <a href="update_notification.php?ID_Noti='.$row_notification['ID_Noti'].'&admin-hang=true" class="iq-sub-card notification-items notification-unseen">
                                                ...
                                                echo '
                                                <a href="update_notification.php?ID_Noti='.$row_notification['ID_Noti'].'&admin-hang=true" class="iq-sub-card notification-items">
                                                   <div class="media align-items-center">
                                                      <div class="media-body ml-3">
                                                         <h6 class="mb-0 ">'.$row_notification['Mota'].'</h6>
                                                      </div>
                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">Thêm chương trình khuyến mại</h4>
                           </div>
                        </div>
                        <div class="iq-card-body">
                           <form id="khuyenmai-form" action="" method="post" enctype="multipart/form-data">
                              <div class="form-group">
                                 ...
                                 <input required type="text" class="form-control" name="TenKhuyenMai">
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group d-flex justify-content-between">
                                 <div style="flex-basis: 40%;">
                                    <label>Bắt đầu:</label>
                                    <input required type="date" class="form-control start-end" name="BatDau" id="BatDau">
                                 </div>
                                 <div style="flex-basis: 40%;">
                                    <label>Kết thúc:</label>
                                    <input required type="date" class="form-control start-end" name="KetThuc" id="KetThuc">
                                 </div>
                              </div>
                              <div class="form-group">
                                 <label>Mức giảm:</label>
                                 <input required type="number" class="form-control" name="MucGiam" min="1" max="100">
                              </div>
                              <button type="submit" class="btn btn-primary" name="submit" value="submit" style="margin-top: 5px">Thêm</button>
                           </form>
                           <script>
