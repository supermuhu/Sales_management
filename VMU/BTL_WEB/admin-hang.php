<?php
   ...
   $sql_getinfo_hang = "select * from hang";
                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           ...
                           <div class="iq-card-header-toolbar d-flex align-items-center">
                              <a href="admin-add-hang.php" class="btn btn-primary">Thêm hãng</a>
                           </div>
                        </div>
                        <div class="iq-card-body">
                                 ...
                                 <tbody>
                                    <?php
                                       while ($res_getinfo_hang = $stmt_getinfo_hang->fetch(PDO::FETCH_ASSOC)) {
                                          ?>
                                             <tr>
                                                <td><?php echo $res_getinfo_hang['ID_Hang']?></td>
                                                <td>
                                                   <img src="<?php echo $res_getinfo_hang['link_hang']?>" class="img-fluid avatar-50 rounded" alt="author-profile">
                                                </td>
                                                <td><?php echo $res_getinfo_hang['TenHang']?></td>
                                                <td>
                                                   <div class="flex align-items-center list-user-action">
                                                      <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="admin-edit-hang.php?ID_Hang=<?php echo $res_getinfo_hang['ID_Hang']?>"><i class="ri-pencil-line"></i></a>
                                                      <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Xoá" href="admin-delete-hang.php?ID_Hang=<?php echo $res_getinfo_hang['ID_Hang']?>"><i class="ri-delete-bin-line"></i></a>
                                                   </div>
                                                </td>
                                             </tr>
                                          <?php
